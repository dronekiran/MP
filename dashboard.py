...
# Zone configuration with constituencies properly grouped by districts
ZONE_DATA = {
    'Zone 1': {
        'Alluri Sitharama Raju': ['Araku', 'Paderu', 'Rampachodavaram'],
        'Anakapalle': ['Anakapalle', 'Chodavaram', 'Madugula', 'Narsipatnam', 'Payakaraopeta', 'Pendurthi (P)', 'Yelamanchili'],
        'Parvathipuram Manyam': ['Kurupam', 'Palakonda', 'Parvathipuram', 'Salur (P)'],
        ...
        'Vizianagaram': ['Bobbili', 'Cheepurupalli', 'Gajapathinagaram', 'Nellimarla', 'Rajam', 'Salur (P)', 'Srungavarapukota', 'Vizianagaram']
    },
    'Zone 2': {
        'Dr. B.R. Ambedkar Konaseema': ['Amalapuram', 'Kothapeta', 'Mandapeta', 'Mummidivaram (P)', 'P. Gannavaram', 'Ramachandrapuram (P)', 'Razole'],
        'East Godavari': ['Anaparthi (P)', 'Gopalapuram (P)', 'Kovvur', 'Nidadavole', 'Rajahmundry City', 'Rajahmundry Rural', 'Rajanagaram'],
        'Eluru': ['Chinthalapudi', 'Denduluru', 'Eluru', 'Kaikalur', 'Nuzivid', 'Polavaram', 'Unguturu'],
        'Kakinada': ['Anaparthi (P)', 'Jaggampeta (P)', 'Kakinada City', 'Kakinada Rural', 'Mummidivaram (P)', 'Peddapuram', 'Pithapuram', 'Prathipadu', 'Ramachandrapuram (P)', 'Tuni'],
    ...
    'Zone 3': {
        ...
        'NTR': ['Gannavaram', 'Jaggayyapeta', 'Mylavaram', 'Nandigama', 'Tiruvuru', 'Vijayawada Central', 'Vijayawada East', 'Vijayawada West'],
    ...
    'Zone 4': {
        'Annamayya': ['Madanapalle', 'Pileru', 'Railway Kodur', 'Rajampeta (P)', 'Rayachoty', 'Thamballapalle'],
        'Chittoor': ['Chittoor', 'Gangadhara Nellore', 'Kuppam', 'Nagari (P)', 'Palamaneru', 'Punganur', 'Puthalapattu'],
        ...
        'Tirupati': ['Chandragiri', 'Gudur', 'Satyavedu', 'Srikalahasti', 'Sullurpeta', 'Tirupati', 'Venkatagiri (P)']
    },
    'Zone 5': {
        ...
        'Nandyala': ['Allagadda', 'Banaganapalle', 'Dhone', 'Nandikotkur', 'Nandyala', 'Panyam (P)', 'Srisailam'],
        'YSR': ['Badvel', 'Jammalamadugu', 'Kadapa', 'Kamalapuram', 'Mydukur', 'Proddatur', 'Pulivendula'],
        'Sri Sathya Sai': ['Dharmavaram', 'Hindupur', 'Kadiri', 'Madakasira', 'Penukonda', 'Puttaparthi', 'Raptadu (P)']
    }
}
